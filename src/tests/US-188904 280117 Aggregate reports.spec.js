...
languages.forEach(language => {
    ...
    test.describe(` Refactored Validate Alerts for Vaccines and Diluents - Language: ${language}`, () => {
        ...
        // ================== TEST 1 ==================
        test(` reee Aggregated reports for vaccines below minimum level`, async ({ page }) => {
